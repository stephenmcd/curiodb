...
/**
 * A fork of LocalSnapshotStore from akka-persistence, that recognizes
 * timestamps in snapshot criterias - for more info see:
 * https://github.com/stephenmcd/curiodb/issues/13
 */
class LocalSnapshotStore extends SnapshotStore with ActorLogging {
